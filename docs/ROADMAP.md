...
- [ ] **3.2.1** Søkefunksjonalitet i prosjekter
...
- [ ] **3.2.4** Eksport av instruksjoner (PDF?)
  - **Mål**: Eksporter instruksjoner til PDF eller annet format
  - **🌐 TEST I NETTLESER**: Test eksport-funksjonalitet hvis implementert
